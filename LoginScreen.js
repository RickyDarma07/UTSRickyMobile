...
class LoginScreen extends React.Component {
 ...
 this.setState({ ActivityIndicator_Loading : true }, () =>
        {
fetch('https://darmax.000webhostapp.com/login.php', 
{
  method: 'POST',
  headers: {
    ...
    return (
      <KeyboardAvoidingView behavior="padding" style = { styles.MainContainer }>
               ...
               <View style={{ flex: 0.3, alignItems:'center', justifyContent: 'center' }}>
                 <Text style={{fontWeight: 'bold', color: '#2196F3' }}>SISTEM PENDAFTARAN</Text>
                 <Text style={{fontWeight: 'bold', color: '#2196F3' }}>KORTI</Text>
               </View>
                <TextInput 
                  placeholder = "Email"
